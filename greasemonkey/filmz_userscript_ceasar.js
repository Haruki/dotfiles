...
(function() {
    ...
    var omdbHost = "http://www.omdbapi.com";
    ...
    //omdb Data
    getOmdbData(pageMovie.imdbcode);
    ...
    function clearSocialDiv() {
        ...
        //var socialDivResult = document.body.querySelectorAll('div .mini-article');
        //console.log("socialdivresult length: " + socialDivResult.length);
        //var socialDivElement = socialDivResult.snapshotItem(0);
        //var socialDivElement = socialDivResult[0];
        var socialDivElement = document.querySelector('div .mini-article');
    ...
    function getReleaseYear() {
        ...
        if (releaseAnchorSearchResult.snapshotLength > 0) {
            ...
            releaseAnchor = releaseAnchorSearchResult.snapshotItem(0);
...
//http://www.omdbapi.com/?i=tt3896198&apikey=c278901
    function getOmdbData(imdbcode) {
        GM_xmlhttpRequest({
            method:"GET",
            url:omdbHost + "/?i=tt" + imdbcode + "&apikey=c278901",
            headers:{
                "User-Agent":"monkeyagent",
                "Accept":"application/json"
            },
            onload:processOmdbData
        });
    }
    ...
    function processOmdbData(result) {
        console.log("omdbData:");
        var response = JSON.parse(result.responseText);
        pageMovieOmdb.namedeutsch = "test";
        console.log("namedeutsch: " + pageMovieOmdb.namedeutsch);
        pageMovieOmdb.nameoriginal = response.Title;
        console.log("nameoriginal: " + pageMovieOmdb.nameoriginal);
        pageMovieOmdb.releasedate = new Date();
        console.log("releasedate: " + pageMovieOmdb.releasedate);
        pageMovieOmdb.score = response.imdbRating;
        console.log("score: " + pageMovieOmdb.score);
    }
